...
from libra.utils import PYDANTIC_V2, to_pascal
...
def get_openai_tool_schema(func: Callable) -> Dict[str, Any]:
    ...
    for param_name, p in params.items():
        ...
        if param_default is Parameter.empty:
            fields[param_name] = (param_type, FieldInfo()) # type: ignore
        else:
            fields[param_name] = (param_type, FieldInfo(default=param_default)) # type: ignore
