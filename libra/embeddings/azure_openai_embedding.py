...
from openai import NOT_GIVEN, NotGiven, AzureOpenAI, AsyncAzureOpenAI
...
class AzureOpenAIEmbedding(BaseEmbedding):
    r"""Provides text embedding functionalities using Azure OpenAI's models.
    ...
    def __init__(
        ...
        self.client = AzureOpenAI(timeout=60, max_retries=3, api_key=self._api_key)
        self.async_client = AsyncAzureOpenAI(timeout=60, max_retries=3, api_key=self._api_key)
